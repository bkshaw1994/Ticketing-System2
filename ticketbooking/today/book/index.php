...
if ( isset( $_SESSION["userid"] ) ) {
    header( "Location:http://localhost/ticketbooking/today/book/master.php" );
...
<!-- Pen Title-->
<div class="pen-title">
  <h1>banglore metro  booking system</h1><span><i class='fa fa-code'></i> by <a href='#'>Apurba Mondal </a><a href='#'>Biswaprakash Ojha </a><a href='#'>Jayesh Agrawat</a><a href='#'>Bishal Kumar Shaw </a><a href='#'>Anish Kumar </a></span>
</div>
